...
const  Billing = ()  =>  (
     <section id="product" className={`${layout.sectionReverse}`}>
       ...
       <div className={`${layout.sectionInfo}`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo nemo velit laborum officia sunt culpa. Repellat exercitationem dolore excepturi pariatur praesentium cupiditate dolorem perferendis expedita?</p>
